window.onload = function () { 
    ...
    function Init() {
        ...
        music.play()
        pers.menu.setText("Bienvenue dans ce jeu \n\n Le but est de résoudre l'enigme disponible dans le carré jaune.\n\n Pour cela déplacez vous avec les flêches directionnelles et pour pivoter, appuyez simulanément SHIFT + FLECHE. \n\nPour résoudre l'énigme, aidez-vous des indices \"camouflés\" dans la pièce \n\nがんばって !  (press enter to continue)")
